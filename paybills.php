...
<?php
	...
	$query2="INSERT INTO creditors (name,timedate,description,debit) VALUES ('$name','$timedate','$description','$debit')";
	$db->query($query);
	$db->query($query2);
...
<div class="col-md-3">
	...
	<div class="col-md-6">
	   <h3 class="text-center"> Pay Bill(s) Bal<?=$diff;?> </h3><hr>

<form class="form" method="post" action="paybills.php">
